public class Lab_9_Mario_Granados {
    ...
    static class HashTable {
        ...
        private void rehash() {
            ...
            for (Node node : oldTable) {
                if (node != null && node.getKey() != -1) {
                    put(node);
                }
            }

            System.out.println("rehash : capacty " + oldCapacity + " -> " + capacity);
        }
    ...
    public static void main(String[] args) {
        ...
        table.put(new Node(31, "Yellow"));
        table.put(new Node(41, "Purple")); 
