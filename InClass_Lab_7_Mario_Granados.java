public class InClass_Lab_7_Mario_Granados {
    public static class HashTable {
        ...
        public void put(Integer value) {
            ...
            while (table[hash] != null) {
                // if the spot is taken move to the next spot
                hash = (hash + 1) % size;
                // if table full return
                if (hash == originalHash) {
                    System.out.println("cannot insurt value:  " + value + " table is full");
                    return;
                }
            }
        ...
        public Integer get(Integer key) {
            ...
            while (table[hash] != null) {
                ...
                hash = (hash + 1) % size;
                if (hash == originalHash) break;  //ran into infinite loop without this 
            }
            return null;
        }
